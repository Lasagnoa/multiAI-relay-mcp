...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "ja": {
        ...
        "update_issue.err_tags_overflow":  "エラー: タグが上限（{max}件）を超えます（追加後: {combined}件）。タグを減らしてから追加してください。",
        "update_issue.err_files_overflow": "エラー: 関連ファイルが上限（{max}件）を超えます（追加後: {combined}件）。ファイルを減らしてから追加してください。",
    ...
    "en": {
        ...
        "update_issue.err_tags_overflow":  "Error: Tags would exceed the limit ({max}). Combined count: {combined}. Remove some tags first.",
        "update_issue.err_files_overflow": "Error: Related files would exceed the limit ({max}). Combined count: {combined}. Remove some files first.",
